...
The final QA/QC query applied to the data removes records where the speed to and from record is greater than 1m/s. These records are highlighted in purple.
