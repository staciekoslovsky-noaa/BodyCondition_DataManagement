...
knit: (function(inputFile, encoding) { 
  rmarkdown::render(
    inputFile, 
    encoding = encoding, 
    output_file = file.path(dirname(inputFile), 'DataSummary_ASLC_20220921_fl11_fieldPrelim.pdf'))
  })
...
images_folder <- 'E:\\2022-09-21\\Images' ## NEEDS TWO (2) BACKSLASHES BETWEEN FOLDER NAMES
lrf_file_path <- 'E:\\2022-09-21\\LRF_data\\aslc_20220921_fl11_lrf.csv' ## NEEDS TWO (2) BACKSLASHES BETWEEN FOLDER NAMES
takeoff_dt <- '2022-09-21 21:47:00' ## Enter 00 for seconds
landing_dt <- '2022-09-21 22:04:59' ## Enter 59 for seconds
