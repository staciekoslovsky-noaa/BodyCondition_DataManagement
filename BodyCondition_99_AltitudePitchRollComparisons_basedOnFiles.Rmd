...
knit: (function(inputFile, encoding) { 
  rmarkdown::render(
    inputFile, 
    encoding = encoding, 
    output_file = file.path(dirname(inputFile), 'DataSummary_ALSC_20220616_fl04.pdf'))
  })
...
flight_date <- '2022-06-16'
flight_number <- 'fl04'
uas_nickname <- 'M2EA'
lrf_name <- 'FB'
offset_seconds <- 0 ## INDICATE positive or negative according to details on datasheet
images_folder <- 'D:\\2022-06-16\\Images' ## NEEDS TWO (2) BACKSLASHES BETWEEN FOLDER NAMES
lrf_file_path <- 'D:\\2022-06-16\\LRF_data\\aslc_20220616_fl04_lrf.csv' ## NEEDS TWO (2) BACKSLASHES BETWEEN FOLDER NAMES
takeoff_dt <- '2022-06-16 18:14:00' ## Enter 00 for seconds
landing_dt <- '2022-06-16 18:33:59' ## Enter 59 for seconds
