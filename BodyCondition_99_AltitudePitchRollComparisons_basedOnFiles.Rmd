...
knit: (function(inputFile, encoding) { 
  rmarkdown::render(
    inputFile, 
    encoding = encoding, 
    output_file = file.path(dirname(inputFile), 'DataSummary_ALSC_20220615_fl02.pdf'))
  })
...
flight_date <- '2022-06-15'
flight_number <- 'fl02'
uas_nickname <- 'M2EA'
lrf_name <- 'FC'
offset_seconds <- -9 ## INDICATE positive or negative according to details on datasheet
images_folder <- 'D:\\2022-06-15\\Images' ## NEEDS TWO (2) BACKSLASHES BETWEEN FOLDER NAMES
lrf_file_path <- 'D:\\2022-06-15\\LRF_data\\aslc_20220615_fl02_lrf.csv' ## NEEDS TWO (2) BACKSLASHES BETWEEN FOLDER NAMES
takeoff_dt <- '2022-06-15 19:09:00' ## Enter 00 for seconds
landing_dt <- '2022-06-15 19:24:59' ## Enter 59 for seconds
